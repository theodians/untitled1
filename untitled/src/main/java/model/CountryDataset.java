...
public class CountryDataset implements Serializable {
    ...
    public CountryDataset(List<CountryData> countryDataList) {
   ...
   public CountryDataset(Integer datasetId, String startYear, String name, String endYear,String description,Country countryCode) {
        this.datasetId = datasetId;
    ...
    public CountryDataset(Integer datasetId, String startYear, String name, String endYear,String description) {
        this.datasetId = datasetId;
        this.startYear = startYear;
        this.name = name;
        this.endYear = endYear;
    ...
    public CountryDataset(ArrayList<Object> data) {
